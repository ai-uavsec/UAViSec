...
class SITLGps : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sensor_msgs.msgs.SITLGps) */ {
 public:
  ...
  bool has_attack_enabled() const;
  void clear_attack_enabled();
  static const int kAttackEnabledFieldNumber = 12;
  bool attack_enabled() const;
  void set_attack_enabled(bool value);
 ...
 private:
  ...
  void set_has_attack_enabled();
  void clear_has_attack_enabled();
...
// optional bool attack_enabled = 12;
inline bool SITLGps::has_attack_enabled() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void SITLGps::set_has_attack_enabled() {
  _has_bits_[0] |= 0x00000800u;
}
inline void SITLGps::clear_has_attack_enabled() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void SITLGps::clear_attack_enabled() {
  attack_enabled_ = false;
  clear_has_attack_enabled();
}
inline bool SITLGps::attack_enabled() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.msgs.SITLGps.attack_enabled)
  return attack_enabled_;
}
inline void SITLGps::set_attack_enabled(bool value) {
  set_has_attack_enabled();
  attack_enabled_ = value;
  // @@protoc_insertion_point(field_set:sensor_msgs.msgs.SITLGps.attack_enabled)
}
